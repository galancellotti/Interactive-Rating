# Frontend Mentor - Componente de avaliação interativo

![Visualização do design do desafio de codificação do componente de classificação interativa](./design/desktop-preview.jpg)
...
Seu desafio é construir esse componente de classificação interativo e fazer com que pareça o mais próximo possível do design.
...
1. Compartilhe a página da sua solução no canal **#finished-projects** da [comunidade](https://www.frontendmentor.io/commu
